              ...
              <div className="relative ">
                ...
                <div className="max-w-4xl p-5 overflow-auto text-lg">
                  ...
                  <div className="mb-1">
                    ...
                    телефон:+359 87 99 888 25/+359 88 888 46 87.УВАЖАЕМИ КЛИЕНТИ
                    , ПРОМЕНИ В СВЕТОВЕН МАЩАБ НАЛАГАТ ПОСТОЯННА АКТУАЛИЗАЦИЯ НА
                    ЦЕНИТЕ НА НАШИТЕ ПРОДУКТИ,ПОРАДИ КОЕТО ЦЕНИТЕ В НАСТОЯЩИЯ НИ
                    КАТАЛОГ ВЕЧЕ НЕ СА ВАЛИДНИ. Информация за актуални цени ,
                    промоции и условия за доставка можете да намерите в нашия
                    сайт или се свържете с нас на телефон:+359 87 99 888 25/+359
                    88 888 46 87.
                  </div>
                </div>
              </div>
